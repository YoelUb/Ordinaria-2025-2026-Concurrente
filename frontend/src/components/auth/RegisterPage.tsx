    ...
    const ValidationHint = ({ field, value }: { field: string, value: string }) => {
        ...
        switch (field) {
            case 'phone':
                ...
                return (
                    <div className={`text-xs mt-1 flex items-center gap-1 ${isValidPhone ? 'text-green-400' : 'text-amber-400'}`}>
            ...
            case 'apartment':
                ...
                return (
                    <div className={`text-xs mt-1 flex items-center gap-1 ${isValidApartment ? 'text-green-400' : 'text-amber-400'}`}>
            ...
            case 'postalCode':
                ...
                return (
                    <div className={`text-xs mt-1 flex items-center gap-1 ${isValidPostalCode ? 'text-green-400' : 'text-amber-400'}`}>
            ...
            case 'password':
                ...
                return (
                    <div className={`text-xs mt-1 flex items-center gap-1 ${isValidPassword ? 'text-green-400' : 'text-amber-400'}`}>
            ...
            <div className="relative z-10 flex items-center justify-center px-4 py-8 md:py-12 md:px-6">
                <div className="w-full max-w-2xl">
                    <div className="text-center mb-8 md:mb-12">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extralight mb-4 text-white">Únete a<br/><span
