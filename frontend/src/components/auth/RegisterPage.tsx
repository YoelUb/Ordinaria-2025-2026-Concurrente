...
import {Lock, Mail, Eye, EyeOff, User, Phone, ArrowRight, Home, AlertCircle} from 'lucide-react';
...
export default function RegisterPage() {
    ...
    const validateForm = () => {
        ...
        // Limpiamos espacios y guiones para validar el teléfono
   ...
   const handleSubmit = async () => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            // Si el error es de email duplicado, lo mostramos en el input correspondiente
        ...
        // Guardamos el email para que la siguiente pantalla sepa a quién verificar
        ...
        // Solo mostramos alerta genérica si no es un error de validación que ya mostramos en el input
    ...
    // Función auxiliar para clases de inputs dinámicos
      ...
      `}</style>
            ...
            <div className="relative z-10 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-2xl">
                    ...
                    <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-3xl space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                {errors.name && (
                                    <div
                                        className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 mt-2 flex items-start gap-2 animate-fade-in">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-2">Número de
                                    apartamento</label>
                                <div className="relative">
                                    <Home size={20}
                  ...
                  Acepto los{' '}
                                    <button type="button" onClick={() => window.location.href = '/terms'}
